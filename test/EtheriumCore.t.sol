...
contract EtheriumCoreTest is EtheriumTestBase {
    ...
    function testPublicGoodsFunding() public {
        ...
        address[2] memory publicGoods = [
            address(0x4B8dF2b0452849e977c73E3D4e8d96be4Dfc3043),
            address(0x4b8e8a62B39EEb85054D175a5dDC81Bb903db78D)
        ];
    ...
    function testPublicGoodsFundingReverts() public {
        ...
        assertTrue(winner != address(0) || auctionAmount > 0, "Should have executed lottery/auction despite public good reverting");
    }
    ...
    function testLOT_POOLTransfersRedirectedToFEES_POOL() public {
        ...
        assertEq(feesPoolAfter, feesPoolBefore + 100 ether, "FEES_POOL should receive 100 tokens (redirected from LOT_POOL)");
    }
